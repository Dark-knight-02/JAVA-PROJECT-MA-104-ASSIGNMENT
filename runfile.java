...
public class runfile {
    public static void main(String[] args) {
        ...
        Result Ned = new Result("Rohan", 2, 3, "Physics", true, false, 50);
        Ned.displayResult();
        System.out.println("");
        Result Sam = new Result("Suresh", 57, 4, "Maths", false, true, 49);
        Sam.displayResult();
        System.out.println("");
        Result John = new Result("Pranav", 56, 2, "Chemistry", true, false, 40);
        John.displayResult();
    }
}
...
class ExamProfile extends Student {
    ...
    public void showScore() {
        ...
        if (punished)
            System.out.println("!!Punished!!\nNot eligible for any bonous marks\nPenalty applied");
        else if (achieved)
            System.out.println("Extra curricular bonous added");
    }
}
